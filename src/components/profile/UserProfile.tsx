	...
	return (
		<div>
		  ...
		  <>
				...
				<div>
					<Image src={props.img} width={200} height={250} className="rounded-xl"/>
				</div>
        <div>
			...
			<div className="flex justify-between mt-10">
					<button className="bg-red-300 h-12 w-32 text-red-700 font-semibold rounded-lg p-3 mt-5">Delete User</button>
					<button className="bg-blue-300 h-12 w-32 text-blue-700 font-semibold rounded-lg p-3 mt-5">Save</button>
